...
class _AdmissionGradesScreenState extends State<AdmissionGradesScreen> {
  ...
  // تم تصحيح الرابط بإزالة البورت وتكرار المسار
  final String baseUrl = 'http://77.42.120.91/api/degrees';
  ...
  Future<List<dynamic>> fetchAcceptedDepartments() async {
    final uri = Uri.parse(
      '$baseUrl?deg=${widget.studentGrade}&chan=${widget.channelId}&brch1=${widget.branch1Id}&brch2=${widget.branch2Id}',
    );
    ...
    try {
      ...
      throw 'تعذر الاتصال بالسيرفر! تأكد من توفر اتصال بالإنترنت على هاتفك.';
    } on TimeoutException {
      throw 'انتهت مهلة الانتظار! السيرفر لا يستجيب، تحقق من اتصال الشبكة.';
    } catch (e) {
      throw 'حدث خطأ غير متوقع أثناء الاتصال: $e';
    }
  }
