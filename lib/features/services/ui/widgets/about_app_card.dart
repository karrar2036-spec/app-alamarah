        ...
        child: Column(
          ...
          children: [
            ...
            _buildServiceItem(
              ...
              title: 'قسم التسجيل والنقوصات',
              description:
                  'نافذة مخصصة لمتابعة كافة النقوصات المتبقية على الطالب (المستمسكات الثبوتية، وثيقة الثانوية، أجور تطبيق HEPIQ، والفحص الطبي).',
              cardBg: cardBg,
            ...
            _buildServiceItem(
              ...
              description:
                  'استعراض ومتابعة موقف القسط الدراسي للطالب والدفعات المتبقية والمستحقة لجميع المراحل الدراسية.',
              cardBg: cardBg,
              borderColor: borderColor,
              textColor: textColor,
            ),
            _buildServiceItem(
              ...
              title: 'القاعات الامتحانية ومقاعد الجلوس',
              description:
                  'عرض تفصيلي لـ اسم ورقم القاعة الامتحانية ومكان جلوس (رقم المقعد) الخاص بالطالب خلال أوقات الامتحانات.',
              cardBg: cardBg,
              borderColor: borderColor,
              textColor: textColor,
            ),
            _buildServiceItem(
              ...
              description:
                  'مكتبة شاملة تتيح تصفح وتحميل المصادر والكتب الأكاديمية والمنهجية المعتمدة لكافة الأقسام.',
              cardBg: cardBg,
              borderColor: borderColor,
              textColor: textColor,
            ),
            ...
            _buildServiceItem(
              ...
              description:
                  'أيقونة الروبوت المجاورة لفتح نافذة المحادثة التفاعلية مع الذكاء الاصطناعي للإجابة عن التساؤلات.',
              cardBg: cardBg,
              borderColor: borderColor,
              textColor: textColor,
            ),
